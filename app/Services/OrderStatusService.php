        ...
        try {
            $result = DB::transaction(function () use ($order, $data, $userId): array {
                ...
                if ($confirming) {
                    ...
                    // ⚡ Bolt: Prevent N+1 queries when acquiring DB locks.
                    // Lock all required variants with a single query.
                    ...
                    foreach ($items as $item) {
                        ...
                        // ⚡ Bolt: No refresh() needed since modern Laravel decrement() updates in-memory attributes.
