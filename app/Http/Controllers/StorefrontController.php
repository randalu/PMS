...
class StorefrontController extends Controller
{
    ...
    public function collection(Category $category): View
    {
        ...
        // ⚡ Bolt: Prevent N+1 queries by injecting the already loaded parent category into each child product
        // Reduces database queries by O(N) when iterating over products in the view
